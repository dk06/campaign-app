app.service('overviewService', function ($rootScope, $http, shareBaseUrl) {
	var url = {};
	var params = {};
    ...
    var promise = $http.get(params.cuberootMarketBaseUrl + 'device' ,{params: {dateRange : param.dateRange,metric : param.metric, campaign_id : param.campaign_id,aggregated : param.aggregated, channel : param.channelAll}} ).then(function(response) {
            return response;
        });
    return promise;
    },
    ...
    var promise = $http.get(params.cuberootMarketBaseUrl + 'brand' ,{params: {dateRange : param.dateRange, metric : param.metric, campaign_id : param.campaign_id,aggregated : param.aggregated, channel : param.channelAll}} ).then(function(response) {
            return response;
        });
    return promise;
    },
    ...
    var promise = $http.get(params.cuberootMarketBaseUrl + 'isp' ,{params: {dateRange : param.dateRange,metric : param.metric, campaign_id : param.campaign_id,aggregated : param.aggregated, channel : param.channelAll}} ).then(function(response) {
            return response;
        });
    return promise;
    },
    ...
    var promise = $http.get(params.cuberootMarketBaseUrl + 'os' ,{params: {dateRange : param.dateRange,metric : param.metric, campaign_id : param.campaign_id,aggregated : param.aggregated, channel : param.channelAll}} ).then(function(response) {
            return response;
        });
    return promise;
    },
    ...
    var promise = $http.get(params.cuberootMarketBaseUrl + 'screensize' ,{params: {dateRange : param.dateRange,metric : param.metric, campaign_id : param.campaign_id,aggregated : param.aggregated, channel : param.channelAll}} ).then(function(response) {
            return response;
        });
    return promise;
    },
    ...
    this.cityData = function(param) {        
        var promise = $http.get(params.cuberootMarketBaseUrl +'cityOthers', { params: {dateRange : param.dateRange,metric : param.metric, campaign_id : param.campaign_id,aggregated : param.aggregated, channel : param.channelAll} }).then(function(response) {
            return response;
        });
        return promise;
    },
